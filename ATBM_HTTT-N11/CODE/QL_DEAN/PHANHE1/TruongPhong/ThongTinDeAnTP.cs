...
namespace PHANHE1.TruongPhong
{
    public partial class ThongTinDeAnTP : Form
    {
        ...
        String userAdmin = "";
        public ThongTinDeAnTP(String usrAdmin)
        {
            InitializeComponent();
            conn.Open();
        ...
        private void ThongTinDeAnTP_Load(object sender, EventArgs e)
        {
            LoadDataToComboBox();
        }
        ...
        private void buttonXemTatCa_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewThongTinDeAnTP.DataSource = table_DSDeAn;
        }
        ...
        private void dataGridViewThongTinDeAnTP_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
